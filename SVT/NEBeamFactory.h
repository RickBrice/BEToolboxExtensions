...
public:
   ...
   static Float64 GetJApprox(NEBeamType type);
};
...
public:
   ...
   virtual Float64 GetJApprox(IndexType beamIdx) const override { return _GetJApprox<NEBeamType, NEBeamFactory>(beamIdx); }
};
