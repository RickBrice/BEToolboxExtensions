...
public:
   ...
   static Float64 GetJApprox3(AASHTOBeamType type);
};
...
public:
   ...
   virtual Float64 GetJApprox3(IndexType beamIdx) const override { return _GetJApprox3<AASHTOBeamType, AASHTOBeamFactory>(beamIdx); }
};
