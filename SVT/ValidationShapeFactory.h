...
public:
   ...
   static Float64 GetJApprox3(ValidationShapeType type);
};
...
public:
   ...
   virtual Float64 GetJApprox3(IndexType beamIdx) const override { return _GetJApprox3<ValidationShapeType, ValidationShapeFactory>(beamIdx); }
};
