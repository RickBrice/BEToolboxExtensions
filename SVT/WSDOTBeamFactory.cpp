...
Float64 WSDOTBeamFactory::GetJApprox(WSDOTBeamType type)
{
   ...
   Float64 d1 = gs_WSDOTBeamDimensions[i][D1];
   Float64 d2 = gs_WSDOTBeamDimensions[i][D2];
   Float64 d3 = gs_WSDOTBeamDimensions[i][D3];
   Float64 d4 = gs_WSDOTBeamDimensions[i][D4];
   Float64 d5 = gs_WSDOTBeamDimensions[i][D5];
   Float64 d6 = gs_WSDOTBeamDimensions[i][D6];
   Float64 d7 = gs_WSDOTBeamDimensions[i][D7];
   Float64 t1 = gs_WSDOTBeamDimensions[i][T1];
   Float64 t2 = gs_WSDOTBeamDimensions[i][T2];
   Float64 w1 = gs_WSDOTBeamDimensions[i][W1];
   Float64 w2 = gs_WSDOTBeamDimensions[i][W2];
   Float64 w3 = gs_WSDOTBeamDimensions[i][W3];
   Float64 w4 = gs_WSDOTBeamDimensions[i][W4];
