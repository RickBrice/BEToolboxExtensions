...
public:
   ...
   static Float64 GetJApprox(TxDOTBeamType type);
};
...
public:
   ...
   virtual Float64 GetJApprox(IndexType beamIdx) const override { return _GetJApprox<TxDOTBeamType, TxDOTBeamFactory>(beamIdx); }
};
