...
std::shared_ptr<WBFL::ReportMgr::ReportSpecification> CM3CAnalysisDetailsReportSpecificationBuilder::CreateReportSpec(const WBFL::ReportMgr::ReportDescription& rptDesc, std::shared_ptr<WBFL::ReportMgr::ReportSpecification> pOldRptSpec) const
{
   return CreateDefaultReportSpec(rptDesc);
}

std::shared_ptr<WBFL::ReportMgr::ReportSpecification> CM3CAnalysisDetailsReportSpecificationBuilder::CreateDefaultReportSpec(const WBFL::ReportMgr::ReportDescription& rptDesc) const
{
